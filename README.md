...
HRV analysis for scanned 10-second ECG PDFs — entirely in your browser, nothing uploaded.
...
Open `index.html` directly, or serve the folder to install it as an offline app:
